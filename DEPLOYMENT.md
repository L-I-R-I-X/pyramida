...
- **Composer не требуется** — зависимости уже включены в `vendor/`
...
### 1. Зависимости
Зависимости уже установлены в папке `vendor/`. Дополнительная установка не требуется.
...
- Имя базы данных: созданная выше база
- Пользователь БД: созданный выше пользователь
- Пароль БД: оставьте пустым, если пароль не требуется
- Логин/пароль администратора: придумайте свои данные
...
Заполните форму:
- **Пароль БД можно оставить пустым**, если ваша база данных не требует пароля
...
- [ ] Создать базу данных и пользователя (или использовать существующие)
